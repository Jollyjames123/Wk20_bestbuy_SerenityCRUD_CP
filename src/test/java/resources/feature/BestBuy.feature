Feature: Run CRUD operation on BestBuy API
  ...
  Scenario Outline: User can run successful CRUD operation on store details
    ...
    Examples:
      ...
      | Watford | Extra | 12 High Street | Watford  | London | LN    | 25687 | 44.879314 | 93.077156 | Mon: 10-9; Tue: 10-9; Wed: 10-9; Thurs: 10-9; Fri: 10-9; Sat: 10-9; Sun: 10-8 |
  ...
  Scenario Outline: User can run successful CRUD operation on product details
    ...
    Examples:
      ...
      | Disney Cars | Toys | 3.49  | 041333424019 | 1234     | Suitable for kids | AmazonToys   | MN2400B4Z | htt://www.bestbuy.com/site/Amazon-aaa-batteries-4-pack/43900.p?id=1051384074145&skuId=43900&cmp=RMXCC | htt://img.bbystatic.com/BestBuy_US/images/products/4390/43900_sa.jpg |
